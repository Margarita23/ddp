...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference("Rating.count") do
      post ratings_url, params: { rating: { eval_method_id: @rating.eval_method_id, name: @rating.name } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { eval_method_id: @rating.eval_method_id, name: @rating.name } }
