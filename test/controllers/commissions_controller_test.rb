...
class CommissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commission" do
    assert_difference("Commission.count") do
      post commissions_url, params: { commission: { name: @commission.name, number: @commission.number } }
    end
  ...
  test "should update commission" do
    patch commission_url(@commission), params: { commission: { name: @commission.name, number: @commission.number } }
