...
class ExpertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expert" do
    assert_difference("Expert.count") do
      post experts_url, params: { expert: { eval_method_id: @expert.eval_method_id, name: @expert.name } }
    end
  ...
  test "should update expert" do
    patch expert_url(@expert), params: { expert: { eval_method_id: @expert.eval_method_id, name: @expert.name } }
