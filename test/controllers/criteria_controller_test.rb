...
class CriteriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create criterium" do
    assert_difference("Criterium.count") do
      post criteria_url, params: { criterium: { eval_method_id: @criterium.eval_method_id, expert_id: @criterium.expert_id, name: @criterium.name } }
    end
  ...
  test "should update criterium" do
    patch criterium_url(@criterium), params: { criterium: { eval_method_id: @criterium.eval_method_id, expert_id: @criterium.expert_id, name: @criterium.name } }
